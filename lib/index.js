...
class Payment {
  constructor({ appid, mchid, partnerKey, pfx, notify_url, refund_url, spbill_create_ip, sandbox } = {}, debug = false) {
    ...
    this.urls = sandbox ? {
      ...
      profitsharing: 'https://api.mch.weixin.qq.com/sandboxnew/secapi/pay/profitsharing',
      multiprofitsharing: 'https://api.mch.weixin.qq.com/sandboxnew/secapi/pay/multiprofitsharing',
      profitsharingquery: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingquery',
      profitsharingaddreceiver: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingaddreceiver',
      profitsharingremovereceiver: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingremovereceiver',
      profitsharingorderamountquery: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingorderamountquery',
      profitsharingmerchantratioquery: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingmerchantratioquery',
      profitsharingfinish: 'https://api.mch.weixin.qq.com/sandboxnew/secapi/pay/profitsharingfinish',
      profitsharingreturn: 'https://api.mch.weixin.qq.com/sandboxnew/secapi/pay/profitsharingreturn',
      profitsharingreturnquery: 'https://api.mch.weixin.qq.com/sandboxnew/pay/profitsharingreturnquery',
    } : {
        ...
        profitsharingquery: 'https://api.mch.weixin.qq.com/pay/profitsharingquery',
        profitsharingaddreceiver: 'https://api.mch.weixin.qq.com/pay/profitsharingaddreceiver',
        profitsharingremovereceiver: 'https://api.mch.weixin.qq.com/pay/profitsharingremovereceiver',
        profitsharingorderamountquery: 'https://api.mch.weixin.qq.com/pay/profitsharingorderamountquery',
        profitsharingmerchantratioquery: 'https://api.mch.weixin.qq.com/pay/profitsharingmerchantratioquery',
        profitsharingfinish: 'https://api.mch.weixin.qq.com/secapi/pay/profitsharingfinish',
        profitsharingreturn: 'https://api.mch.weixin.qq.com/secapi/pay/profitsharingreturn',
        profitsharingreturnquery: 'https://api.mch.weixin.qq.com/pay/profitsharingreturnquery',
      };
    this.debug = debug;
  }
  ...
  async getH5Params(params) {
    params.trade_type = params.trade_type || 'MWEB';
    let order = await this.unifiedOrder(params);
    return {
      appid: order.appid,
  ...
  multiProfitSharing(params) {
    ...
    return this._request(pkg, 'multiprofitsharing', true);
  }
  ...
  profitSharingQuery(params) {
    ...
    return this._request(pkg, 'profitsharingquery', false);
  }

  // 添加分账接收方
  addProfitSharingReceiver(params) {
    let pkg = {
      ...params,
      appid: this.appid,
      mch_id: this.mchid,
  ...
  // 删除分账接收方
  removeProfitSharingReceiver(params) {
    let pkg = {
      ...params,
      appid: this.appid,
      mch_id: this.mchid,
  ...
  profitSharingReturn(params) {
    ...
    return this._request(pkg, 'profitsharingreturn', true);
  }

  // 查询订单待分账金额
  profitSharingOrderAmountQuery(params) {
    let pkg = {
      ...params,
      appid: this.appid,
      mch_id: this.mchid,
    ...
    return this._request(pkg, 'profitsharingorderamountquery', false);
  }
}
